...
sed -i "s/iconicactions/$PROJECT_NAME/g" "$TARGET_DIR/werf.yaml" "$TARGET_DIR/werf.sh" "$TARGET_DIR/build.sh" "$TARGET_DIR/runit.sh" "$TARGET_DIR/.helm/templates/deployment.yaml"
